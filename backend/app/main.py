...
from app.routes import auth, api_keys, chat, context, history, sessions, settings, system, download, hardware, upload, models_api, gguf, image_generation, websocket, runtimes, mlx, projects, admin, usage, orgs, api_tokens, artifacts, comfyui, agents
...
{APP_VERSION} - All-in-one AI Workspace, LLM Inference, and Runtime Manager.
https://lmwebui.com
""")
