...
class RAGConfig(BaseModel):
    ...
    context_token_budget: int = Field(default=16000, ge=100, le=32000, description="Max tokens of capability context (RAG chunks, web search pages, file text) injected into the prompt")
