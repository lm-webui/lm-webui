      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 text-sm bg-transparent border-b border-zinc-300/50 dark:border-zinc-800/50 text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 focus:border-zinc-500 dark:focus:border-zinc-400 transition-colors"
          />
        </div>
        <Button
          variant="ghost"
